...
public class ResultPack<R extends Serializable> implements Serializable {
    ...
    public ResultStack<R> getResult(TupleImpl<Double> k) {
        if(!this.table.containsKey(k)){
    ...
    public Set<Entry<Tuple<Double>, ResultStack<R>>> getParetoOptima(Function<R, Double> eval1, boolean maximize1, Function<R, Double> eval2, boolean maximize2) {
